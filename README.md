...
### Проект развёрнут на сервере http://51.250.108.111/
...
Авторы, а также главные Python-разработчики учебного проекта:
- :white_check_mark: [V1cimus Petr Volozhanin (в роли Python-разработчика Тимлид - разработчик 1)](https://github.com/V1cimus)
- :white_check_mark: [Maxim-Bolobaiko (в роли Python-разработчика - разработчик 2)](https://github.com/Maxim-Bolobaiko)
- :white_check_mark: [BotnTheOne Dmitry Borzunov (в роли Python-разработчика - разработчик 3)](https://github.com/BotnTheOne)
